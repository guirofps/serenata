...
const EXEMPLOS = [
  { slug: "es-mariachi", titulo: "El Mandil Azul", para: "para la mamá", genero: "Mariachi" },
  { slug: "es-banda", titulo: "El Pedazo de Pastel", para: "para la esposa", genero: "Banda" },
  { slug: "es-balada", titulo: "El Frasco de Nescafé", para: "para el abuelo", genero: "Balada" },
] as const;
        ...
        <div className="mt-8 space-y-3">
          {EXEMPLOS.map((e) => {
            ...
            return (
              ...
              >
                <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-[var(--acento)] text-[var(--papel)]">
                  {ativo ? (
