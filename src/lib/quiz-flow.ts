...
export const QUIZ_FLOW: FlowStep[] = [
  ...
  },
  {
    ...
    subtext: "É esse nome que vai ser cantado na música.",
    field: "nome",
    input: "text",
  ...
  },
  {
    ...
    kind: "question",
    block: "O estilo",
    text: "Que estilo combina com essa história?",
  ...
  },
  {
    ...
    kind: "question",
    block: "A história",
    text: "O que essa pessoa é pra você?",
  ...
  },
  {
    ...
    kind: "question",
    block: "A história",
    text: "Se ela pudesse ouvir UMA frase sua no refrão, qual seria?",
